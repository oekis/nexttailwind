...
export default function index() {
  return (
    <header className="m-0 bg-primary bg-opacity-80">
      <div className="flex item-center justify-between">
        <div className="flex">
          <a
            href="#"
            className="item-center m-3 text-white text-opacity-50 hover:text-opacity-75"
          >
        ...
        <div className="flex mx-4">
          <ul className="flex items-center space-x-12 font-medium text-xxl text-textNav">
            <li>
              <Link href="/">
                <a>Home</a>
              </Link>
